        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-6 ml-auto d-flex">
            <div class="ml-md-auto top-social d-none d-lg-inline-block">
              	<a href="/" class="d-inline-block p-3"><span class="icon-home"></span></a>
                <a href="#" class="d-inline-block p-3"><span class="icon-user"></span></a>
                <a href="/web/main/loginPage.do" class="d-inline-block p-3"><span class="icon-sign-in"></span></a>
                <a href="#" class="d-inline-block p-3"><span class="icon-live_tv"></span></a>
            </div>
          </div>
    ...
    <div class="site-section py-0">
      <div class="owl-carousel hero-slide owl-style">
        <div class="site-section">
          <div class="container">
            <div class="half-post-entry d-block d-lg-flex bg-light">
              ...
              <div class="contents">
                <span class="caption">드루이드 계약서</span>
        ...
        <div class="site-section">
          <div class="container">
            <div class="half-post-entry d-block d-lg-flex bg-light">
              <div class="img-bg" style="background-image: url('images/big_img_2.jpg')"></div>
              <div class="contents">
